...
%------------- BEGIN CODE --------------
    ...
    methods
        ...
        % Maximum parititioning (allows PCA featuring)        
        y = ME(obj,length,epsilon,dimension,mu,coeff)
        
        % Maximum partitioning with the help of mapminmax
        %y = MEmapminmax(obj,length,epsilon,dimension,mu,coeff)
...
MergeIntervalPlot(I,fillType,Num)

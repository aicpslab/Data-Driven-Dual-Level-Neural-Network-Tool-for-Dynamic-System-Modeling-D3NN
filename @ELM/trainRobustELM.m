function ELM=trainRobustELM(ELM,Input,Output,delta)
...
Input_u = P+delta*ones(size(Input));
Input_l = P-delta*ones(size(Input));

[H_l,H_u]=computelayerOutput(Input_l',Input_u',IW,ELM1.bias{1},'sig');
